...
struct PostModel {
    ...
    static func makeData() -> [[PostModel]] {
        ...
        section.append(PostModel(author: "Porsche Cat", description: "Линейка Cayenne пополнилась еще одним представителем, обладающим невероятной мощью и точной динамикой. Cayenne Turbo GT обладает всеми необходимыми предпосылками для того, чтобы с самого начала занять лидирующие позиции.", image: "CayenneTurboGT", likes: 134, views: 280))
        section.append(PostModel(author: "Porsche Cat", description: "Идея Panamera. С типичной для Porsche динамикой и одновременно высокой экономичностью? Невозможно – говорили многие. Смело – утверждали другие.", image: "PanameraGTS", likes: 151, views: 452))
